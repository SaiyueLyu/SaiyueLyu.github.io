...
I am a Computer Science Ph.D. student at the [University of British Columbia](https://www.cs.ubc.ca/){:target="\_blank"} supervised by Prof. [Mathias Lécuyer](http://mathias.lecuyer.me/){:target="\_blank"}. I am interested in privacy-preserving machine learning. Currently I am working on randomized smoothing. I also work with Prof. [Mijung Park](https://www.cs.ubc.ca/~mijungp/){:target="\_blank"} on differentially private data generation.
